    ...
    return (
        <div className='section-margin'>
            <div className='align-center'>
                <BrowserView>
                    <p className='green-color-txt font-25'>Contact us on</p>
                    <hr className='seprator'/>
                </BrowserView>
                <MobileView>
                    <p className='green-color-txt'>Contact us on</p>
                    <hr className='seprator'/>
                </MobileView>
            </div>
            <div className='width-100-percent flex-row'>
                <div className='social-ico-section'>
                    <a href="#0" className="c-link c-link--facebook c-tooltip" aria-label="Facebook">
                        <svg className="c-icon"><use xlinkHref="#icon--facebook"></use>
                        </svg>
                    </a>
